<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agente.aspx.cs" Inherits="ProyectoIPC2.agente" %>
        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="#"><img src="datos/img/tr.jpg" alt="" /></a>
					<h2>Agente:<span class="min-dtn"> <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label> </span></h2>
				</div>
			</div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="agente.aspx"><span class="mini-sub-pro">Principal</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Inicio<span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="agente.aspx">Principal</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </nav>
                    ...
                    <div class="panel-body">
                        <form action="#" id="loginForm">
                            ...
                            <div class="text-center">
                                <asp:Button ID="Button1" runat="server" Text="Buscar" class="btn btn-success loginbtn" OnClick="Button1_Click" />
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <form action="#" id="loginForm">
                            ...
                            <div class="text-center">
                                <asp:Button ID="Button2" runat="server" Text="Registrar" class="btn btn-success loginbtn" OnClick="Button2_Click"/>
                            </div>
                        </form>
                    </div>
                </div>
