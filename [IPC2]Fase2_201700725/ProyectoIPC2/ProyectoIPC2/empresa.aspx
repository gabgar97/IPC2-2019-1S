...
<section id="fancyTabWidget" class="tabs t-tabs">
        ...
        <div id="myTabContent" class="tab-content fancyTabContent" aria-live="polite">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox2" runat="server" class="form-control" placeholder="Especialidad"></asp:TextBox>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="postres" runat="server" class="form-control">
                    ...
                    <asp:ListItem>No</asp:ListItem>
                                    ...
                                    <asp:Button ID="Button1" runat="server" Text="Ingresar" class="btn btn-info btn-lg btn-responsive" />
                                </div>
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="gimnasio" runat="server" class="form-control">
                    ...
                    <asp:ListItem>No</asp:ListItem>
                                    ...
                                    <div class="clearfix"></div>
                                    <asp:Button ID="Button2" runat="server" Text="Ingresar" class="btn btn-info btn-lg btn-responsive" />                                  
                                </div>
                            </div>
                    </div>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="tarifa" runat="server" class="form-control" placeholder="Tarifa"></asp:TextBox>
                                    ...
                                    <div class="clearfix"></div>
                                    <asp:Button ID="Button3" runat="server" Text="Ingresar" class="btn btn-info btn-lg btn-responsive" />
                                </div>
                            </div>
                    </div>
        </div>
